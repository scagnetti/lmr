...
class SharesControllerTest < ActionController::TestCase
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post :create, share: { financial: @share.financial, isin: @share.isin, name: @share.name, size: @share.size }
    end
  ...
  test "should update share" do
    put :update, id: @share, share: { financial: @share.financial, isin: @share.isin, name: @share.name, size: @share.size }
    assert_redirected_to share_path(assigns(:share))
  end
