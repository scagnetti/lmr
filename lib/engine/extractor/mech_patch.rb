# Sine we are using TOR we get this error message when running OnVistaIndexValueExtractor:
# too many connection resets (due to Broken pipe - Errno::EPIPE)
# after 19 requests on 86126850, last used 0.098711144 seconds ago
